...
class PlantNameList extends StatefulWidget {
  ...
  @override
  _PlantNameListState createState() => _PlantNameListState();
}

class _PlantNameListState extends ModularState<PlantNameList, DashboardStore> with SingleTickerProviderStateMixin {
          ...
          : Container(
              ...
              child: DropdownSearch<String>(
                ...
                popupTitle: Container(
                  ...
                  child: Center(
                    child: Text(
                      'Plantas (${store.plantNameList?.length})',
                      style: TextStyle(
                        fontSize: 20,
