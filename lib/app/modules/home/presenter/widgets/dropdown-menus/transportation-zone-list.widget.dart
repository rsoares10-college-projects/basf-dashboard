...
class TransportationZoneList extends StatefulWidget {
  const TransportationZoneList({
    Key? key,
  }) : super(key: key);

  @override
  _TransportationZoneListState createState() => _TransportationZoneListState();
}

class _TransportationZoneListState extends ModularState<TransportationZoneList, DashboardStore> with SingleTickerProviderStateMixin {
      ...
      builder: (context) => store.sbuList == null
          ...
          : Container(
              ...
              child: DropdownSearch<String>(
                ...
                mode: Mode.DIALOG,
                items: store.transportationZoneList,
                dropdownSearchDecoration: InputDecoration(
                  labelText: "Zona de Transporte",
                ...
                popupTitle: Container(
                  ...
                  child: Center(
                    child: Text(
                      'Zonas de Transporte (${store.transportationZoneList?.length})',
                      style: TextStyle(
                        fontSize: 20,
