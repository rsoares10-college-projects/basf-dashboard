...
class Inco1ShipmentList extends StatefulWidget {
  const Inco1ShipmentList({
    Key? key,
  }) : super(key: key);

  @override
  _Inco1ShipmentListState createState() => _Inco1ShipmentListState();
}

class _Inco1ShipmentListState extends ModularState<Inco1ShipmentList, DashboardStore> with SingleTickerProviderStateMixin {
      ...
      builder: (context) => store.sbuList == null
          ...
          : Container(
              ...
              child: DropdownSearch<String>(
                ...
                maxHeight: 300.0,
                mode: Mode.DIALOG,
                items: store.inco1ShipmentList,
                dropdownSearchDecoration: InputDecoration(
                  labelText: "Inco 1 (shipment)",
                ...
                popupTitle: Container(
                  ...
                  child: Center(
                    child: Text(
                      'Inco 1 (Shipment) (${store.inco1ShipmentList?.length})',
                      style: TextStyle(
                        fontSize: 20,
