...
class _StateListState extends ModularState<StateList, DashboardStore> with SingleTickerProviderStateMixin {
          ...
          : Container(
              ...
              child: DropdownSearch<String>(
                ...
                popupTitle: Container(
                  ...
                  child: Center(
                    child: Text(
                      'Estados (${store.stateNameList?.length})',
                      style: TextStyle(
                        fontSize: 20,
